...
class Projekform(forms.ModelForm):
    ...
    tajukkerja = forms.CharField(required=False, widget=forms.Textarea(attrs={'class':'form-control font-weight-700','type':'text','placeholder':'Tajuk Kerja','rows':'5'}))
    daerah = forms.ChoiceField(choices=daerah, required=False, widget=forms.Select(attrs={'class':'form-control custom-select select28 ','placeholder':'baru'}))
    pgred = forms.ChoiceField(choices=gred, required=False, widget=forms.Select(attrs={'class':'form-control custom-select select28 ','placeholder':'baru'}))
    pkategori = forms.ChoiceField(choices=catkontraktor, required=False, widget=forms.Select(attrs={'class':'form-control custom-select select28 ','placeholder':'baru'}))
    ...
    ptaraf = forms.ChoiceField(choices=taraf, required=False, widget=forms.Select(attrs={'class':'form-control custom-select select28 ','placeholder':'baru'}))
    ptempohsiap = forms.CharField(required=False, widget=forms.TextInput(attrs={'class':'form-control','type':'text','value':''}))
    pweekormonth = forms.ChoiceField(choices=tempoh, required=False, widget=forms.Select(attrs={'class':'form-control custom-select select28 ','placeholder':'baru'}))
    ...
    latitud2 = forms.CharField(required=False, widget=forms.TextInput(attrs={'class':'form-control','type':'text','value':'','placeholder':'Minutes'}))
    latitud3 = forms.CharField(required=False, widget=forms.TextInput(attrs={'class':'form-control','type':'text','value':'','placeholder':'Seconds'}))
    longlitud1 = forms.CharField(required=False, widget=forms.TextInput(attrs={'class':'form-control','type':'text','value':'','placeholder':'Degree'}))
