...
class Kontraktor(models.Model):
    ...
    #malumat Permohonan]
    konMPTarikhMohon = models.DateField(null=True, blank=True)
    ...
    konMPtarikhkeluar = models.DateField(null=True, blank=True)
    konMPtarikhtamat = models.DateField(null=True, blank=True)
    #Disemak
    konMPdisemak = models.CharField(max_length=100, null=True, blank=True)
    konMPjawatansemak = models.CharField(max_length=50, null=True, blank=True)
    konMPdisah = models.CharField(max_length=100, null=True, blank=True)
    konMPjawatansah  = models.CharField(max_length=50, null=True, blank=True)
    konMPlulus= models.CharField(max_length=100, null=True, blank=True)
    konMPjawatanlulus = models.CharField(max_length=50, null=True, blank=True)
    #sijil Perakuan pendaftaran kontraktor (PPK)
    sijilPPKNoPendaftaran = models.CharField(max_length=100, null=True, blank=True)
    sijilPPKSahDari = models.DateField(null=True, blank=True)
    sijilPPKTamat  = models.DateField(null=True, blank=True)
    ...
    sijilPPKKhuSatu = models.CharField(max_length=200, null=True, blank=True)
    ...
    sijilPPKKhuDua = models.CharField(max_length=200, null=True, blank=True)
    ...
    sijilPPKKhuTiga = models.CharField(max_length=200, null=True, blank=True)
    #sijil Perakuan pendaftaran kontraktor (SPKK)
    sijilSPKKNoPendaftaran = models.CharField(max_length=50, null=True, blank=True)
    sijilSPKKSahDari = models.DateField(null=True, blank=True)
    sijilSPKKTamat = models.DateField(null=True, blank=True)
    ...
    sijilSPKKKhuSatu = models.CharField(max_length=200, null=True, blank=True)
    ...
    sijilSPKKKhuDua = models.CharField(max_length=200, null=True, blank=True)
    ...
    sijilSPKKKhuTiga = models.CharField(max_length=200, null=True, blank=True)
    #sijilTarahBumiputera
    sijilSTBNoPendaftaran = models.CharField(max_length=100, null=True, blank=True)
    sijilSTBSahDari = models.DateField(null=True, blank=True)
    sijilSTBTamat = models.DateField(null=True, blank=True)
    sijilSTBGred = models.CharField(max_length=50, null=True, blank=True)
    #sijilSSM
    sijilSSMNoPendaftaran = models.CharField(max_length=100, null=True, blank=True)
    sijilSSMSahDari = models.DateField(null=True, blank=True)
    sijilSSMTamat = models.DateField(null=True, blank=True)
    #sijilSST
    sijilSSTNoPendaftaran = models.CharField(max_length=100, null=True, blank=True)
    sijilSSTSahDari = models.DateField(null=True, blank=True)
    sijilSSTTamat = models.DateField(null=True, blank=True)
    #sijilJPS
    sijilJPSNoPendaftaran = models.CharField(max_length=100, null=True, blank=True)
    sijilJPSSahDari = models.DateField(null=True, blank=True)
    sijilJPSTamat = models.DateField(null=True, blank=True)
