# Generated by Django 3.2 on 2021-08-15 14:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tajukkursus', models.CharField(blank=True, max_length=500, null=True)),
                ('tarikhmula', models.DateField(blank=True, null=True)),
                ('tarikhakhir', models.DateField(blank=True, null=True)),
                ('tempat', models.CharField(blank=True, max_length=150, null=True)),
                ('tahun', models.CharField(blank=True, max_length=10, null=True)),
                ('hari', models.CharField(blank=True, max_length=10, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='isSungai',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('konMPTarikhMohon', models.DateField(blank=True, null=True)),
                ...
                ('konMPtarikhkeluar', models.DateField(blank=True, null=True)),
                ('konMPtarikhtamat', models.DateField(blank=True, null=True)),
                ...
                ('sijilPPKSahDari', models.DateField(blank=True, null=True)),
                ('sijilPPKTamat', models.DateField(blank=True, null=True)),
                ...
                ('sijilSPKKSahDari', models.DateField(blank=True, null=True)),
                ('sijilSPKKTamat', models.DateField(blank=True, null=True)),
                ...
                ('sijilSTBSahDari', models.DateField(blank=True, null=True)),
                ('sijilSTBTamat', models.DateField(blank=True, null=True)),
                ...
                ('sijilSSMSahDari', models.DateField(blank=True, null=True)),
                ('sijilSSMTamat', models.DateField(blank=True, null=True)),
                ('sijilSSTNoPendaftaran', models.CharField(blank=True, max_length=100, null=True)),
                ('sijilSSTSahDari', models.DateField(blank=True, null=True)),
                ('sijilSSTTamat', models.DateField(blank=True, null=True)),
                ('sijilJPSNoPendaftaran', models.CharField(blank=True, max_length=100, null=True)),
                ('sijilJPSSahDari', models.DateField(blank=True, null=True)),
                ('sijilJPSTamat', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mrksatukontraktor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.kontraktor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groupunit', models.CharField(blank=True, max_length=50, null=True)),
                ('unitsokongan', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jbankmrksatulink', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.mrksatu')),
                ('projekbind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.projek')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bonmrksatulink', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.mrksatu')),
                ('projekbind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.projek')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projekbind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.projek')),
                ('smrkmrksatulink', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.mrksatu')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('khasmrksatulink', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.mrksatu')),
                ('projekbind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.projek')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projekbind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.projek')),
                ('ssmrksatulink', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.mrksatu')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projekbind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.projek')),
                ('psmkmrksatulink', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.mrksatu')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projekbind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.projek')),
                ('pskmrksatulink', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.mrksatu')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projekbind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.projek')),
                ('wjpmrksatulink', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.mrksatu')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marktigamrksatu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.mrksatu')),
                ('projekbind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.projek')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mrksatulink', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bindone', to='jpskit.mrksatu')),
                ('projekbind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.projek')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lskmrksatulink', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bindtwo', to='jpskit.mrksatu')),
                ('projekbind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jpskit.projek')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projekbind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='jpskit.course')),
            ],
        ),
    ]
